...
const Section = styled.section`margin-top: 1rem;padding-top: 1rem;
...
const BioticList = ({ biotic }) => {
  ...
  return (
    <>
      ...
      <Section>
        <HelpText>
        These habitats represent the Biotic Component (BC) of the <OutboundLink from="/" to="https://iocm.noaa.gov/cmecs/" target="_blank">Coastal and Marine Ecological Classification Standard</OutboundLink> (CMECS) for estuaries of the West Coast of the contiguous United States.
        <br />
<br />        
These habitats were derived using information from the National Wetlands Inventory (NWI), NOAA’s Coastal Change Analysis Program (C-CAP), and Oregon Coastal Management Program.

<br />
<br />
For more information and data access, <OutboundLink from="/" to="http://www.pacificfishhabitat.org/data/estuarine-biotic-habitat" target="_blank">click here</OutboundLink>.
</HelpText>
      </Section>
    </>
  )
